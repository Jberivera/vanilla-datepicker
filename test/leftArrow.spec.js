...
let datepicker, leftArrow, headerMonth, headerYear, days, cols;

describe('changes the months backwards by clicking the left arrow button', function () {
  before(function () {
    datepicker = document.querySelector('.datepicker .date');
    leftArrow = datepicker.querySelector('.date__left-arrow');
  ...
  it('December last year', function () {
    expect(headerMonth.value).toBe('11');
    expect(headerYear.value).toBe('2015');
